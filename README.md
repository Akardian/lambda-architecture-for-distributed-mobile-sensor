# lambda-architecture-for-distributed-mobile-sensor-nodes
...
The goal of this project is it to create a lambda architecture, with current technology like Apache Spark to process
generated by mobile sensor nodes.
