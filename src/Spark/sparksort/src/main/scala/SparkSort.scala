...
object SparkSort {
    ...
    def main(args: Array[String]) {
        ...
        sendStream(wifiData, BOOTSTRAP_SERVERS, TOPICS_ODOMCLEAN, CHECKPOINT_KAFKA_ODOMCLEAN)
        ...
        sendStream(wifiData, BOOTSTRAP_SERVERS, TOPICS_ODOMDISTANCE, CHECKPOINT_KAFKA_ODOMDISTANCE)
